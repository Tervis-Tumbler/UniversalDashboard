...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UdChart; });
...
/* harmony import */ var react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(667);
/* harmony import */ var _services_fetch_service_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var react_interval__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35);
...
/* harmony import */ var _ud_input_field_jsx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(549);
/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13);
...
function (_React$Component) {
  _inherits(UdChart, _React$Component);

  function UdChart(props) {
    var _this;

    _classCallCheck(this, UdChart);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(UdChart).call(this, props));
    _this.state = {
      chartData: null,
      errorMessage: "",
      hasError: false,
  ...
  _createClass(UdChart, [{
    ...
    key: "onChartClicked",
    value: function onChartClicked(elements) {
      if (!this.props.clickable) {
        return;
      }

      pubsub_js__WEBPACK_IMPORTED_MODULE_6___default.a.publish('element-event', {
        type: "clientEvent",
        eventId: this.props.id + "onClick",
        eventName: 'onClick',
        eventData: JSON.stringify(elements.map(function (x) {
          return x._view;
        }))
      });
    }
    ...
    value: function componentWillUnmount() {
      pubsub_js__WEBPACK_IMPORTED_MODULE_6___default.a.unsubscribe(this.pubSubToken);
    }
  }, {
    key: "onValueChanged",
    ...
    value: function loadData() {
      ...
      Object(_services_fetch_service_jsx__WEBPACK_IMPORTED_MODULE_3__[/* fetchGet */ "a"])("/api/internal/component/element/".concat(this.props.id).concat(queryString), function (json) {
        if (json.error) {
          this.setState({
            hasError: true,
    ...
    value: function componentWillMount() {
      this.loadData();
      this.pubSubToken = pubsub_js__WEBPACK_IMPORTED_MODULE_6___default.a.subscribe(this.props.id, this.onIncomingEvent.bind(this));
    }
  }, {
    key: "renderArea",
    value: function renderArea() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__[/* Polar */ "g"], {
        data: this.state.chartData,
        options: this.props.options,
        onElementsClick: this.onChartClicked.bind(this)
      });
    }
  }, {
    key: "renderDoughnut",
    value: function renderDoughnut() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__[/* Doughnut */ "c"], {
        data: this.state.chartData,
        options: this.props.options,
        onElementsClick: this.onChartClicked.bind(this)
      });
    ...
    value: function renderBar() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__[/* Bar */ "b"], {
        data: this.state.chartData,
        options: this.props.options,
        onElementsClick: this.onChartClicked.bind(this)
      });
    ...
    value: function renderLine() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__[/* Line */ "e"], {
        data: this.state.chartData,
        options: this.props.options,
        onElementsClick: this.onChartClicked.bind(this)
      });
    ...
    value: function renderRadar() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__[/* Radar */ "h"], {
        data: this.state.chartData,
        options: this.props.options,
        onElementsClick: this.onChartClicked.bind(this)
      });
    ...
    value: function renderPie() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__[/* Pie */ "f"], {
        data: this.state.chartData,
        options: this.props.options,
        onElementsClick: this.onChartClicked.bind(this)
      });
    ...
    value: function renderHorizontalBar() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__[/* HorizontalBar */ "d"], {
        data: this.state.chartData,
        options: this.props.options,
        onElementsClick: this.onChartClicked.bind(this)
      });
    ...
    value: function render() {
      ...
      if (this.state.hasError) {
        ...
        }), ", ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_interval__WEBPACK_IMPORTED_MODULE_4___default.a, {
      ...
      if (this.state.fields != null) {
        fields = this.state.fields.map(function (x) {
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_materialize__WEBPACK_IMPORTED_MODULE_1__["Col"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ud_input_field_jsx__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], _extends({
            key: x.name
          }, x, {
        ...
        fields = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_materialize__WEBPACK_IMPORTED_MODULE_1__["Row"], null, fields);
      }
      ...
      if (this.props.width !== null && this.props.height !== null) {
        ...
        this.props.options = _objectSpread({}, options, this.props.options);
      ...
      }, this.props.title), chart, fields, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_interval__WEBPACK_IMPORTED_MODULE_4___default.a, {
        timeout: this.props.refreshInterval * 1000,
        enabled: this.props.autoRefresh,
        callback: this.loadData.bind(this)
      })), actions);
...
//# sourceMappingURL=ud-chart.98b6e0fc72b16353d581.bundle.map